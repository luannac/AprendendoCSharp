...
namespace ExerciciosWindowsForm
{
    public partial class V11 : Form
    {
        ...
        private void preencheTabela()
        {
            ...
            dgvTabela.Rows.Add(matriz[0, 0], matriz[0, 1], matriz[0, 2], matriz[0, 3], matriz[0, 4]);
            dgvTabela.Rows.Add(matriz[1, 0], matriz[1, 1], matriz[1, 2], matriz[1, 3], matriz[1, 4]);
            dgvTabela.Rows.Add(matriz[2, 0], matriz[2, 1], matriz[2, 2], matriz[2, 3], matriz[2, 4]);
            dgvTabela.Rows.Add(matriz[3, 0], matriz[3, 1], matriz[3, 2], matriz[3, 3], matriz[3, 4]);
            dgvTabela.Rows.Add(matriz[4, 0], matriz[4, 1], matriz[4, 2], matriz[4, 3], matriz[4, 4]);
        }
