...
namespace ExercicioRevisao.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProdutos,nome,valor")] Produtos produtos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProdutos,nome,valor")] Produtos produtos)
        {
            if (ModelState.IsValid)
            {
